...
data class GetAllDetailProdusenRequestResponse(

	@field:SerializedName("data")
	val dataAllDetailProdusenRequestResponseItem: List<DataAllDetailProdusenRequestResponseItem>,
...
data class DataAllDetailProdusenRequestResponseItem(
